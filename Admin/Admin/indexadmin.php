...
<body class="">
  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
      ...
      <!-- Brand -->
      <a class="navbar-brand pt-0" href="indexadmin.html">
          ...
          <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link nav-link-icon" href="insertcat.php">
                ...
                <span class="ni ni-ui-04">Insert Categories</span>
              </a>
            </li>
            ...
            <li class="nav-item">
              <a class="nav-link nav-link-icon" href="report.php">
                
                <span class="ni ni-ui-04">Reports</span>
              </a>
            </li>
          </ul>
        <!-- Divider -->
        ...
        <div class="row align-items-center justify-content-xl-between">
          <div class="col-xl-6">
            <div class="copyright text-center text-xl-left text-muted">
              &copy; 2019 <a href="https://www.creative-tim.com" class="font-weight-bold ml-1" target="_blank">Travel_City</a>
            </div>
          </div>
        </div>
      </footer>
