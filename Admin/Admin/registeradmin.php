						...
						<form action="insertadmin.php" method="post">
							...
							<div class="row form-group">
								<div class="col-md-12 padding-bottom">
									...
									<input type="text" id="aname" name="aname" class="form-control" placeholder="Your name">
								</div>
							</div>
							...
							<div class="row form-group">
								<div class="col-md-12">
									...
									<input type="text" id="email" name="aemail" class="form-control" placeholder="Your email">
								</div>
							</div>
							...
							<div class="row form-group">
								<div class="col-md-12">
									...
									<input type="password" id="password" name="apass" class="form-control" placeholder="Your Password">
								</div>
							</div>
							...
							<div class="row form-group">
								<div class="col-md-12">
									...
									<input type="password" id="confrim password" name="cpass" class="form-control" placeholder="Confirm Your Password">
								</div>
							</div>
