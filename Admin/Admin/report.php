...
<body class="bg-default">
  <div class="main-content">
    ...
    <!-- start of report -->
    <?php 
    $sql="select * from buyer where buyerid='2'";
	...
	echo "<center><h1 style='color: Pink;'>The buyer who bought many item more than other in this month <br><br>";
	echo "ID: $byid<br>";
	echo "Name: $bname<br>";
	echo "Email: $bemail<br>";
	echo "Phone: $bph<br>";
	echo "Address: $badd<br><br><br>";
	
	$sql="select * from seller where sellerid='1'";
	foreach ($db->query($sql) as $row){
	$sid=$row['sellerid'];
	...
	echo "<center><h1 style='color: Pink;'>The seller who uploaded many item more than others in this month <br><br>";
	echo "ID: $sid<br>";
	echo "Name: $sname<br>";
	echo "Email: $semail<br>";
	echo "Phone: $sph<br>";
	echo "Address: $sadd<br>";;
    ?>
    <!-- end of report -->
  </div>
  <!-- Footer -->
