          ...
          <div class="card bg-secondary shadow border-0">
			...
			<form action="" method="post">
				<div class="form-group">
					<input type="text" name="itemprice" value="<?php echo $price; ?>" readonly class="form-control">
				</div>
				
				<div class="form-group">
					<input type="text" name="newprice" class="form-control" required placeholder="Enter New Price" required>
				</div>
...
if(isset($_POST['update']))
{
	...
	$sql1="update item set itemprice='$newprice' where itemid='$item_ID'";
	$db->exec($sql1);
	
	echo "<script>alert('Update Successful');location.href='updateitem.php'</script>";
