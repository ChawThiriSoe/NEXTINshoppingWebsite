...
<body>
	...
	<!-- end of header -->
		<?php 
				...
				$sql="select * from orders where buyerid='$bbid'";
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-10">
				<h1>Thank You!! Your Order is Received!!</h1><br>
			</div>
		</div>
		<div class="row">
			<div class="col-md-3"></div>
			<div class="col-md-9">
				<h2>Waiting for Payment</h2><br>
			</div>
		</div>
		<div class="row">
			<div class="col-md-3"></div>
			<div class="col-md-9">
				<h3>Your order number is <?php echo $orderid;?></h3><br>
			</div>
		</div>
		<div class="row">
			<div class="col-md-3"></div>
			<div class="col-md-9">
				<font size="4">Please have this amount ready on deliver day.</font><br>
				<font size="5" style="padding-left: 100px;">$ <?php echo $orderprice;?></font><br><br>
			</div>
		</div>
		<div class="row">
			<div class="col-md-2"></div>
			<div class="col-md-10">
				<font size="4">We've sent a confirmation email to your email with the order details.</font><br>
				<font size="4">Your order will be deivered between 4 days to your palce (<?php echo $address;?>).</font>
			</div>
		</div>
